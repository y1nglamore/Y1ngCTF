<?php
header('Hint: home.php');
?>
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

    <title>颖奇L'Amore</title>
    <link rel="icon" sizes="any" mask="" href="fav.png">
...
<div id="container">
    ...
    <div>
        <h1 id="h1" class="transition-in">Welcome to BJDCTF</h1>
        <h3 id="h3">&nbsp; </h3>
        <h3>
        </h3>
        <h3 id="h3">&nbsp; </h3>
        ...
        <a href="https://gem-love.com/" target="_blank"><font color="white"><h3 id="h3">@颖奇L'Amore</h3></font></a>
        <h3>
        </h3>
    </div>
...
<canvas id="canvas" width="1680" height="938"></canvas>
